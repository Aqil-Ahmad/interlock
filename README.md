...
[AGPL-3.0-only](LICENSE), with a commercial license available for organisations
that cannot accept AGPL terms. Reasoning in [ADR-0002](docs/adr/0002-license.md).
